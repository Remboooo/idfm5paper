...
class TFT_eSPI : public Print {
 ...
 public:
  ...
  bool _write_exceed_area = false;
  uint32_t _write_len = 0;
  uint32_t _last_write_len = 0;
  uint16_t _write_font_height = 0;
  uint8_t _write_unicode_len = 0;
 ...
 protected:
  int32_t _textarea_x, _textarea_y, _textarea_w, _textarea_h;
...
protected:
  ...
  uint16_t _fill_margin_right = 0;
  int16_t _fill_margin_top = 0;
  int16_t _fill_margin_bottom = 0;
  bool _fill_margin_active = 0;
  bool _use_freetype_font = 1;
  uint16_t _ft_font_size = 0;
