...
void setup()
{
    ...
    log_d("idfm5: begin");
    M5.begin(/*touchEnable*/ true, /*SDEnable*/ false, /*SerialEnable*/ false, /*BatteryADCEnable*/ true, /*I2CEnable*/ true);
...
extern "C" void app_main()
{
    ...
    // Disable the task watchdog timer for the arduino core and unsubscribe the idle task from trying to trigger it
    ...
    xTaskCreatePinnedToCore(loopTask, "loopTask", 81920, NULL, 1, NULL, ARDUINO_RUNNING_CORE);
}
